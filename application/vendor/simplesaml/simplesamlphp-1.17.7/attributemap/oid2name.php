...
$attributemap += [
    ...
    'urn:oid:1.3.6.1.4.1.6807.2.2.1' => 'eltedbServiceToken',
    'urn:oid:1.3.6.1.4.1.6807.2.2.2' => 'elteFakeBasicAuth',
    'urn:oid:1.3.6.1.4.1.6807.2.2.10' => 'eltedbSessionUser',
    'urn:oid:1.3.6.1.4.1.6807.2.2.11' => 'eltedbSessionPassword',
    'urn:oid:1.3.6.1.4.1.6807.2.2.12' => 'elteBetaAccess',
    'urn:oid:1.3.6.1.4.1.6807.2.2.13' => 'elteDevelAccesses',
    'urn:oid:1.3.6.1.4.1.6807.2.2.14' => 'elteMailAccount',
    'urn:oid:1.3.6.1.4.1.6807.2.2.15' => 'elteMailDisabled',
    'urn:oid:1.3.6.1.4.1.6807.2.2.16' => 'elteOwncloudAccess',

    'urn:oid:1.3.6.1.4.1.1466.115.121.1.36' => 'schacYearOfBirth',
    'urn:oid:1.3.6.1.4.1.25178.1.2.17' => 'schacExpiryDate',
];
